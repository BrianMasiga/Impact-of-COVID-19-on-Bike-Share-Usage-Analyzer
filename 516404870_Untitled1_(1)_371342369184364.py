...
bike_2019_Q1 = pd.read_csv(
    "C:\\Users\\HP\\Desktop\\Python\\metro-bike-share-trips-2019-q1.csv", index_col=2, parse_dates=[2, 3])
...
bike_2019_Q2 = pd.read_csv(
    "C:\\Users\\HP\\Desktop\\Python\\metro-bike-share-trips-2019-q2.csv", index_col=2, parse_dates=[2, 3])
...
bike_2019_Q3 = pd.read_csv(
    "C:\\Users\\HP\\Desktop\\Python\\metro-bike-share-trips-2019-q3.csv", index_col=2, parse_dates=[2, 3])
...
bike_2019_Q4 = pd.read_csv(
    "C:\\Users\\HP\\Desktop\\Python\\metro-bike-share-trips-2019-q4.csv", index_col=2, parse_dates=[2, 3])
...
bike_2020_Q1 = pd.read_csv(
    "C:\\Users\\HP\\Desktop\\Python\\metro-trips-2020-q1.csv", index_col=2, parse_dates=[2, 3])
...
bike_2020_Q2 = pd.read_csv(
    "C:\\Users\\HP\\Desktop\\Python\\metro-trips-2020-q2.csv", index_col=2, parse_dates=[2, 3])
...
bike_2020_Q3 = pd.read_csv(
    "C:\\Users\\HP\\Desktop\\Python\\metro-trips-2020-q3.csv", index_col=2, parse_dates=[2, 3])
...
bike_2020_Q4 = pd.read_csv(
    "C:\\Users\\HP\\Desktop\\Python\\metro-trips-2020-q4.csv", index_col=2, parse_dates=[2, 3])
...
plt.plot(week_numbers_2019, weekly_trips_2019.values,
         label="2019", color='blue')
plt.plot(week_numbers_2020, weekly_trips_2020.values,
         label="2020", color='green')
plt.plot(forecast_week_numbers, weekly_trips_forecast,
         label="Forecast_2020", color='red')
plt.xlabel('Week')
plt.ylabel('Trips')
...
bike_2019['start_station_Count'] = bike_2019.groupby(
    'start_station')['start_station'].transform('count')
bike_2019.head()
...
bike_2019 = bike_2019[['start_station', 'start_lat',
                       'start_lon', 'start_station_Count']]
...
top_5_stations = bike_2019['start_station'].value_counts().nlargest(
    5).reset_index()
top_5_stations.columns = ['start_station', 'trips']

# Get the least 5 start stations based on the number of trips
least_5_stations = bike_2019['start_station'].value_counts(
...
map = folium.Map(location=[bike_2019.iloc[0]['start_lat'],
                 bike_2019.iloc[0]['start_lon']], zoom_start=12)
...
def get_token():
    token = json.loads(requests.post(url_token, headers=headers).text)[
        'guest_token']
...
def removeStopWords(sentence):
    ...
    filtered_sentence = [w.lower()
                         for w in tokens if not w.lower() in stop_words]
    removed_punct_sentence = [
        w for w in filtered_sentence if not w in punctuation]
...
output_file = open(emotion_data_save_path, mode="w",
...
output_file = open(pos_keyword_save_path, mode="w",
                   encoding='utf8',  newline='')
csv_writer = csv.writer(output_file)
...
output_file = open(neg_keyword_save_path, mode="w",
                   encoding='utf8',  newline='')
csv_writer = csv.writer(output_file)
